...
const LendBookForm = ({ onLend, prefilledIsbn, onClose }: LendBookFormProps) => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            await Swal.fire({
                title: 'Error',
                text: error?.response?.data?.message || "Failed to lend book",
                icon: 'error',
                confirmButtonColor: '#4f46e5'
            });
        } finally {
    ...
    return (
        <div className="max-w-md mx-auto mt-4 sm:mt-8 p-4 sm:p-6 bg-white border rounded-lg shadow-lg">
                ...
                <div className="space-y-1">
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            value={memberId}
                            onChange={(e) => setMemberId(e.target.value)}
                            className="w-full border border-gray-300 rounded-lg p-2 pl-20 sm:pl-24 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            required
                            maxLength={5}
                            pattern="[0-9]{5}"
                            title="Please enter exactly 5 digits"
